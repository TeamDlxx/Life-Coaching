...
const QuoteDetail = (props) => {
    ...
    const { Token, checkPermissions, downloadQuote, dashboardData, setDashBoardData, setBadgeCount } = useContext(Context)
